    ...
    return WillPopScope(
      ...
      child: Obx(() => Scaffold(
            ...
            bottomNavigationBar: BottomNavigationBar(
              ...
              unselectedLabelStyle: const TextStyle(fontFamily: "NotoR", color: Colors.black, fontSize: FontSize.xSmall),
              selectedLabelStyle: const TextStyle(fontFamily: "NotoB", color: Colors.red, fontSize: FontSize.xSmall),
